...
pygame.font.init()
title_font = pygame.font.Font('Chapter Two/CHAOS METAL.ttf', 120) # Font name, Size, Bold, Italic
subtitle_font = pygame.font.Font('Chapter Two/Agasiz.ttf', 80) # Font name, Size, Bold, Italic
